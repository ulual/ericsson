...
(
    ...
    userLabel String "Slot=2,DefaultRouter"
        defaultRouter0 String "42.109.54.113" // New Corenet Default Gateway
        networkPrefixLength Integer 29
        rps Boolean false
        vLan Boolean true
        mtu Integer 1500
        trafficType Integer  7
        vid Integer 2436 // Change the VLAN if required
)
...
(
    ...
    exception none
    nrOfAttributes 2
    ipAddress String "42.109.54.116" //new Corenet UP_CP IP address
...
(
    mo "ManagedElement=1,IpSystem=1,IpAccessHostEt=1"
    exception none
    ipAddress String "42.109.54.116"
)
